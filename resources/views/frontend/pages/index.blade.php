...
@section('main')
            ...
            <div class="row">
                <div class="banner-bottom">
                    <div class="banner-inner">
                        <div class="banner-block banner-block-4 mar-b-30">
                            <div class="banner-block">
                                <img src="{{ asset('frontend/images/banner/13.jpg') }}" alt="" />
                                <div class="banner-content">
                                    <div class="banner-text">
                                        <span class="banner-discount">Big Discount</span>
                                        <span class="banner-title">20% Off</span>
                                        <span class="banner-stitle">Men shoes collection</span>
                                    </div>
                                    <span class="banner-btn"><a href="shop-left-sidebar-col-3.html">Shop
                                            Now</a></span>
                                </div>
                            </div>
                        </div>
                        <div class="banner-block banner-block-5">
                            <div class="banner-block">
                                <img src="{{ asset('frontend/images/banner/14.jpg') }}" alt="" />
                                <div class="banner-content">
                                    <div class="banner-text">
                                        <span class="banner-discount">Big Discount</span>
                                        <span class="banner-title">40% Off</span>
                                        <span class="banner-stitle">Women jacket collection</span>
                                    </div>
                                    <span class="banner-btn"><a href="shop-left-sidebar-col-3.html">Shop
                                            Now</a></span>
                                </div>
                                ...
                                <div class="pro-option">
                                    ...
                                    <div class="pro-size">
                                        <ul class="opt-size">
                                            ...
                                            <li><a href="#" class="opt-sz" data-old="$460.00"
                                                    data-new="$409.00" data-tooltip="Medium">36</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="pro-size">
                                        <ul class="opt-size">
                                            ...
                                            <li><a href="#" class="opt-sz" data-old="$480.00"
                                                    data-new="$429.00" data-tooltip="Extra Large">XL</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
    ...
    <!--  offer Section Start -->
    <section class="section offer-section section-space-mt section-space-mb">
        <h2 class="d-none">Offer</h2>
        <img src="{{ asset('frontend/images/offer-image/offer_bg_2.jpg') }}" alt="" class="offer_bg" />
        <div class="offer-inner">
            <div class="row justify-content-end">
                <div class="col-xl-6 col-lg-7 col-md-7 col-sm-7 align-self-center offer-content">
                    <h2 class="offer-stitle">Style Of The Year</h2>
                    <h2 class="offer-title">Trading Offer Sale</h2>
                    <span class="offer-desc">New Product Purchase Up To 50% Off All Now Fast Shopping</span>
                    <span class="offer-btn"><a href="#" class="btn btn-lg btn-primary">Shop
                            Now</a></span>
                </div>
            </div>
        </div>
    ...
    <!-- Ec Instagram Start -->
    <section class="section instagram-section section-space-p">
        <div class="container">
            <div class="row">
                    ...
                    <div class="insta-outer">
                        <div class="insta-auto">
                            ...
                            <div class="insta-item">
                                <div class="insta-inner">
                                    <a href="#" target="_blank"><img
                                            src="{{ asset('frontend/images/instragram-image/1.jpg') }}"
                                            alt="">
                            ...
                            <div class="insta-item">
                                <div class="insta-inner">
                                    <a href="#" target="_blank"><img
                                            src="{{ asset('frontend/images/instragram-image/2.jpg') }}"
                                            alt="">
                            ...
                            <div class="insta-item">
                                <div class="insta-inner">
                                    <a href="#" target="_blank"><img
                                            src="{{ asset('frontend/images/instragram-image/3.jpg') }}"
                                            alt="">
                            ...
                            <div class="insta-item">
                                <div class="insta-inner">
                                    <a href="#" target="_blank"><img
                                            src="{{ asset('frontend/images/instragram-image/4.jpg') }}"
                                            alt="">
                            ...
                            <div class="insta-item">
                                <div class="insta-inner">
                                    <a href="#" target="_blank"><img
                                            src="{{ asset('frontend/images/instragram-image/5.jpg') }}"
                                            alt="">
