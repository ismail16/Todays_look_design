                ...
                <div class="col-md-12 align-self-center">
                    <div class="main-menu">
                        <ul>
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)">Products <i class="ecicon eci-angle-down"></i></a>
                                <ul class="sub-menu">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)">Pages <i class="ecicon eci-angle-down"></i></a>
                                <ul class="sub-menu">
                            ...
                            <li class="dropdown">
                                ...
                                <a href="javascript:void(0)">Others <i class="ecicon eci-angle-down"></i></a>
                                <ul class="sub-menu">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)">Blog <i class="ecicon eci-angle-down"></i></a>
                                <ul class="sub-menu">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)">Elements <i class="ecicon eci-angle-down"></i></a>
                                <ul class="sub-menu">
